...
import { Eye, EyeOff, Key, HardDrive } from "lucide-react";
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <p className="text-[10px] text-text-muted/60 leading-relaxed">
        Cloud keys are stored locally in your browser. Local provider connects to your Ollama instance — no API key needed, $0 cost.
      </p>
    </div>
  );
}
